    ...
    <Dialog open={showModal}>
      <DialogContent className="max-w-[800px]  gap-2 text-darkblue">
        <DialogHeader className="text-m  ">
          <DialogTitle>
            <h2 className="text-l  text-darkblue">개인정보 수집 및 이용 동의서(필수)</h2>
          </DialogTitle>
          (재)이노베이션 아카데미는 『개인정보 보호법』 제15조 등 관련 법령에 따라 서비스 이용자의
          개인정보보호를 매우 중시하며, 서비스 제공에 반드시 필요한 개인정보의 수집⦁이용을 위하여
          귀하의 동의를 받고자 합니다.
        </DialogHeader>
        <Accordion type="multiple" className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>개인정보의 수집 및 이용 목적</AccordionTrigger>
            <AccordionContent>어디있니 현재 위치 확인 서비스 제공</AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              귀하는 개인정보 수집 및 이용에 대해 동의를 거부할 권리가 있습니다. 필수항목에 대한
              동의 거부 시 어디있니 서비스 제공이 제한됨을 알려드립니다.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
